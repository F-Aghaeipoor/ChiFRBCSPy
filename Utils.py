...
def load_data(dataset_name):
    if dataset_name == 'data_myron':
        ### Without FS
        X_tr = pd.read_csv(
            'C:\\Users\\MASNA.CO\\Desktop\\SEARCHES\\Codes\\data\\data_myron\\GSE89843_TEP_Count_Matrix_ruvseq_diff_1_training.csv',
            index_col=0)
        y_tr = pd.read_csv(
            'C:\\Users\\MASNA.CO\\Desktop\\SEARCHES\\Codes\\data\\data_myron\\ruvseq_diff_1_training.csv', sep=",",
            index_col=0)
        X_tst = pd.read_csv(
            'C:\\Users\\MASNA.CO\\Desktop\\SEARCHES\\Codes\\data\\data_myron\\GSE89843_TEP_Count_Matrix_ruvseq_diff_1_test.csv',
            index_col=0)
        y_tst = pd.read_csv('C:\\Users\\MASNA.CO\\Desktop\\SEARCHES\\Codes\\data\\data_myron\\ruvseq_diff_1_test.csv',
                            sep=",", index_col=0)
        X_tr = np.array(X_tr)
        ...
        y_nn = pd.read_csv('C:/Users/MASNA.CO/Desktop/SEARCHES/Codes/data/data_myron/predicted.csv', sep=',',
                           index_col=0)
        ...
        data = pd.read_csv('C:/Users/MASNA.CO/Desktop/SEARCHES/Codes/data/breast_cancer_uci/breast_cancer_uci.csv',
                           sep=',', )
        ...
        y_nn = pd.read_csv('C:/Users/MASNA.CO/Desktop/SEARCHES/Codes/data/breast_cancer_uci/predicted.csv', sep=',',
                           index_col=0)
        ...
        data = pd.read_csv('C:/Users/MASNA.CO/Desktop/SEARCHES/Codes/data/LetterRecognitionComplete/data.csv',
                           sep=',', )
        X = data.drop([target_col_name], axis=1).values
        y = data[target_col_name].values
        print(X.shape, y.shape)
        X_tr, X_tst, y_tr, y_tst = train_test_split(X, y, test_size=0.33, random_state=42)
        FI_X = pd.read_csv('C:/Users/MASNA.CO/Desktop/SEARCHES/Codes/data/LetterRecognitionComplete/FI_X.csv',
                           sep=',', )
        y_nn = pd.read_csv('C:/Users/MASNA.CO/Desktop/SEARCHES/Codes/data/LetterRecognitionComplete/predicted.csv',
                           sep=',', index_col=0)
